...
### <a name="hybrid-workplace"></a>Local de trabalho híbrido
...
#### <a name="run-effective-meetings"></a>Executar reuniões efetivas
...
#### <a name="create-inclusive-meeting-environments"></a>Criar ambientes de reunião inclusivos
...
#### <a name="asynchronous-collaboration-and-co-authoring"></a>Colaboração e coautoridade assíncronas
...
#### <a name="manage-team-schedules-with-shifts"></a>Gerenciar agendamentos de equipe com turnos
...
#### <a name="create-approvals"></a>Criar aprovações
...
#### <a name="create-a-form-and-view-results"></a>Criar um formulário e exibir resultados
...
#### <a name="formulas-and-functions"></a>Fórmulas e funções
