...
### <a name="office-365-was-rebranded-to-microsoft-365"></a>O Office 365 foi remarcado para a Microsoft 365
O Office 365 foi remarcado para a Microsoft 365. A alteração do nome é refletida no conteúdo dos caminhos de aprendizado do Microsoft 365. 

### <a name="new-or-updated-playlists"></a>Playlists novas ou atualizadas
As seguintes playlists foram adicionadas ou atualizadas.  
...
##### <a name="best-practices-for-collaborating-with-office-365-6-new-assets"></a>Práticas recomendadas para colaboração com o Office 365 (6 novos ativos)
- Introdução
- Compartilhar
- Coautoria
- Chat em arquivos
...
### <a name="office-for-the-web"></a>Office para a Web
...
- Colaborar online
- Coisas interessantes no Word para a Web
#### <a name="excel-for-the-web"></a>Excel para a Web
- Conheça o Excel para a Web
- Criar fórmulas
- Inserir uma tabela dinâmica
- Obtenha idéias com ideias
- Colaborar
- Economize tempo com o preenchimento relâmpago
...
- Quando estiver pronto para apresentar
- Design de slides
