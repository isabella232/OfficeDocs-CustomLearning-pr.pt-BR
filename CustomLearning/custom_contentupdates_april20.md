...
#### <a name="collaborate-in-teams-and-channels-1-new1-updated-asset"></a>Colaborar em equipes e canais (1 ativo atualizado novo/1)
- Criar e usar canais privados (novos)
- Mostrar ou ocultar canais (atualizados)
#### <a name="start-chats-and-calls-2-new1-updated"></a>Iniciar chats e chamadas (2 novo/1 atualizado)
...
#### <a name="manage-meetings-3-new4-updated-assets"></a>Gerenciar reuniões (3 novos/4 ativos atualizados)
...
#### <a name="work-with-post-and-messages-1-new"></a>Trabalhar com postagem e mensagens (1 novo)
- Postar uma mensagem em vários canais (novo)
...
#### <a name="get-started-5-new-assets"></a>Começar (5 novos ativos)
- Introdução
