...
Com os caminhos de aprendizado, a maneira como você trabalha com as listas de reprodução personalizadas depende de como você provisionou o site de cursores de aprendizado. 
...
## <a name="create-or-copy-a-playlist-and-have-it-translated"></a>Criar ou copiar uma lista de reprodução e fazer com que ela seja convertida
...
### <a name="copy-a-playlist-and-have-it-translated"></a>Copiar uma lista de reprodução e fazer com que ela seja convertida
...
4. Alterar o título da lista de reprodução. Neste exemplo, alteraremos o título da playlist para **cinco etapas simples**. Observe que os idiomas disponíveis dependerão dos idiomas com suporte selecionados para o site. Para adicionar outros idiomas, você precisa adicionar outros idiomas com suporte no site.   
...
## <a name="create-multilingual-assets-in-a-custom-playlist"></a>Criar ativos multilíngues em uma lista de reprodução personalizada
...
### <a name="create-a-new-multilingual-asset-for-a-playlist"></a>Criar um novo ativo multilíngue para uma lista de reprodução
...
**Para abrir o ativo**
1. Selecione o ativo que você acabou de criar e clique em **abrir**.  
...
## <a name="add-languages-for-existing-custom-playlists-and-assets"></a>Adicionar idiomas para listas de reprodução e ativos personalizados existentes
...
### <a name="to-add-languages-for-an-existing-playlist"></a>Para adicionar idiomas para uma lista de reprodução existente
1.  No menu **principal** de cursores de aprendizado, clique em **Administração de caminhos de aprendizado**. 
...
5. Selecione **salvar detalhes**.
 Observe que os idiomas disponíveis dependerão dos idiomas com suporte selecionados para o site. Para adicionar outros idiomas, você precisa adicionar outros idiomas com suporte no site.   
...
## <a name="add-languages-for-an-existing-custom-playlist"></a>Adicionar idiomas para uma lista de reprodução personalizada existente
